...
export const scenes = [
  ...
  { id: 'test', mood: 'think', view: 'app', url: 'student.html?page=11', clip: 'p06-test', kicker: '데일리 테스트', label: '교과 + 영재원 스타일', note: '쉬운 문제부터 깊이 생각할 문제까지' },
  ...
  { id: 'self', mood: 'encourage', view: 'app', url: 'student.html?page=3', clip: 'p09-self', kicker: '스스로 공부하기', label: '우루사쌤이 한 단계씩', note: '예상 → 측정 → 기록 → 다시 확인' },
  { id: 'lab', mood: 'think', view: 'app', url: 'student.html?page=5', clip: 'p10-lab', kicker: '3D 가상 실험', label: '진짜처럼 움직이는 용수철저울', note: '영점 → 매달기 → 눈금 읽기' },
  { id: 'voice', view: 'app', url: 'student.html?page=12', clip: 'l2-elastic', kicker: '실제 수업 음성', label: '당겼다 놓으면?', note: '실험하면서 우루사쌤이 바로 옆에서' },
  { id: 'mistake', mood: 'surprise', view: 'app', url: 'student.html?page=5', clip: 'p11-mistake', kicker: '과정을 스스로 점검', label: '답 대신 질문으로', note: '"어떤 과정을 다시 살펴볼까?"' },
  { id: 'grade', mood: 'encourage', view: 'app', url: 'student.html?page=11', clip: 'p11b-grade', kicker: '데일리 테스트', label: '채점 · 첨삭 · 처방 문제', note: '두 번 헷갈리면 비슷한 문제로 다시' },
  { id: 'battle', mood: 'praise', view: 'app', url: 'teacher.html?page=5', clip: 'p12-battle', kicker: '가르치기', label: '두 팀 배틀', note: '같은 물건, 두 개의 저울, 한 판 승부', hold: 2 },
  ...
  { id: 'end', mood: 'praise', view: 'slide', clip: 'p16-end', chip: C, kicker: '대치 MSG 영재교육', title: ['초등과학심화,', '이제 살아 움직인다'], sub: '초·과·심 LIVE — 스스로 공부 · 가르치기 · 살아있는 책', art: 'cover' },
];
