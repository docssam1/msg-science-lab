...
## 2026-09-23 추가 탐구 · 측정 방법 점검
- 본책 10쪽 앞 추가 탐구 2쪽(원본 문항 아님); 두 물체 예상, 비슷한 세 물체 줄 세우기, 다섯 물체 측정.
- 학생의 측정 제출 후 실제 교구 상태를 검사. 첫 오류는 원인을 노출하지 않는 일반 안내. 기준 오차·진동·관찰 위치를 점검하며 잘못된 예상과 방법 오류를 분리.
- 모든 인쇄 지면에 해당 활동의 고정 ID QR; 원본 18문항 보존. 총 20쪽.
- 추가 두 도입의 읽기와 오류 피드백은 기기 한국어 음성(OmniVoice 추가 생성 아님). 기존18개 OmniVoice 유지.
